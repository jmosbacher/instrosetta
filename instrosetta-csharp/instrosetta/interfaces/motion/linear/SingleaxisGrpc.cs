...
namespace Devices.Motion.Linear.Singleaxis {
  public static partial class SingleLinearAxis
  {
    ...
    static readonly grpc::Marshaller<global::Devices.Motion.Linear.Singleaxis.Distance> __Marshaller_devices_motion_linear_singleaxis_Distance = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Devices.Motion.Linear.Singleaxis.Distance.Parser.ParseFrom);
    ...
    static readonly grpc::Method<global::Devices.Motion.Linear.Singleaxis.MoveRelativeRequest, global::Devices.Motion.Linear.Singleaxis.Distance> __Method_MoveRelative = new grpc::Method<global::Devices.Motion.Linear.Singleaxis.MoveRelativeRequest, global::Devices.Motion.Linear.Singleaxis.Distance>(
        grpc::MethodType.ServerStreaming,
        __ServiceName,
        "MoveRelative",
        __Marshaller_devices_motion_linear_singleaxis_MoveRelativeRequest,
        __Marshaller_devices_motion_linear_singleaxis_Distance);
    ...
    public abstract partial class SingleLinearAxisBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task MoveRelative(global::Devices.Motion.Linear.Singleaxis.MoveRelativeRequest request, grpc::IServerStreamWriter<global::Devices.Motion.Linear.Singleaxis.Distance> responseStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public partial class SingleLinearAxisClient : grpc::ClientBase<SingleLinearAxisClient>
    {
      ...
      public virtual grpc::AsyncServerStreamingCall<global::Devices.Motion.Linear.Singleaxis.Distance> MoveRelative(global::Devices.Motion.Linear.Singleaxis.MoveRelativeRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return MoveRelative(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncServerStreamingCall<global::Devices.Motion.Linear.Singleaxis.Distance> MoveRelative(global::Devices.Motion.Linear.Singleaxis.MoveRelativeRequest request, grpc::CallOptions options)
      {
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, SingleLinearAxisBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_MoveRelative, serviceImpl == null ? null : new grpc::ServerStreamingServerMethod<global::Devices.Motion.Linear.Singleaxis.MoveRelativeRequest, global::Devices.Motion.Linear.Singleaxis.Distance>(serviceImpl.MoveRelative));
    }
